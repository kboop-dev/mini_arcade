...
const List<TicketDefinition> ticketCatalog = [
  ...
  TicketDefinition(
    ...
    prizeText: 'Vale por una salida al cine juntos 🎬',
  ...
  TicketDefinition(
    ...
    gameKey: 'puzzle',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por un día de spa juntos 💆',
  ...
  TicketDefinition(
    ...
    gameKey: 'puzzle',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por una cena en tu restaurante favorito 🍽️',
  ...
  TicketDefinition(
    ...
    gameKey: 'minesweeper',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por un pan de muerto juntos 🍞',
  ...
  TicketDefinition(
    ...
    gameKey: 'minesweeper',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por una tarde de videojuegos sin interrupciones 🎮',
  ...
  TicketDefinition(
    ...
    gameKey: 'minesweeper',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por un postre gratis de tu elección 🍰',
  ...
  TicketDefinition(
    ...
    gameKey: 'hangman',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por elegir tú la próxima película 🎥',
  ...
  TicketDefinition(
    ...
    gameKey: 'hangman',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por un masaje de 15 minutos 💕',
  ...
  TicketDefinition(
    ...
    title: '¡Ticket Especial!',
    prizeText: 'Vale por una salida a jugar arcade de verdad 🕹️',
  ...
  TicketDefinition(
    ...
    gameKey: 'battle_target',
    title: '¡Ticket Especial!',
    prizeText: 'Vale por el desayuno que tú elijas 🥞',
